...
suite('Extension Test Suite', () => {
    ...
    test('should register all commands on activation', () => {
        ...
        commandNames.forEach((command, index) => {
            assert(registerCommandStub.getCall(index).args[0] === command,
    ...
    test('should handle run test command', async () => {
        ...
        const runTestCommand = registerCommandStub.getCalls()
    ...
    test('should handle debug test command', async () => {
        ...
        const debugTestCommand = registerCommandStub.getCalls()
    ...
    test('should handle refresh command', async () => {
        ...
        const refreshCommand = registerCommandStub.getCalls()
        ...
        assert((vscode.commands.executeCommand as sinon.SinonStub)
            .calledWith('codelens.refresh'));
    });
